...
class UnifiedDataClient:
    ...
    def get_leaderboard_data(self, season: int, group: str, stat_type: str, limit: int, offset: int) -> pd.DataFrame:
        return MlbStatsClient.get_leaderboard_data(season, group, stat_type, limit, offset)
